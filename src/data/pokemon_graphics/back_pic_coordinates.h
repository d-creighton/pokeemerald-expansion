...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_CHIKORITA]                    = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 10 },
    [SPECIES_BAYLEEF]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
    [SPECIES_MEGANIUM]                     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_CYNDAQUIL]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_QUILAVA]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_TYPHLOSION]                   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_TOTODILE]                     = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 10 },
    [SPECIES_CROCONAW]                     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_FERALIGATR]                   = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_SENTRET]                      = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  0 },
    [SPECIES_FURRET]                       = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_HOOTHOOT]                     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  4 },
    [SPECIES_NOCTOWL]                      = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  3 },
    [SPECIES_LEDYBA]                       = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  8 },
    [SPECIES_LEDIAN]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_SPINARAK]                     = { .size = MON_COORDS_SIZE(64, 32), .y_offset = 16 },
    [SPECIES_ARIADOS]                      = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    [SPECIES_CROBAT]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_CHINCHOU]                     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    [SPECIES_LANTURN]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    ...
    [SPECIES_TOGEPI]                       = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 12 },
    [SPECIES_TOGETIC]                      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_NATU]                         = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 15 },
    [SPECIES_XATU]                         = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_MAREEP]                       = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    ...
    [SPECIES_HOPPIP]                       = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  8 },
    [SPECIES_SKIPLOOM]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_JUMPLUFF]                     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  3 },
    [SPECIES_AIPOM]                        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_SUNKERN]                      = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    [SPECIES_SUNFLORA]                     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  7 },
    [SPECIES_YANMA]                        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_WOOPER]                       = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 12 },
    ...
    [SPECIES_GLIGAR]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_STEELIX]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_SNUBBULL]                     = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 12 },
    [SPECIES_GRANBULL]                     = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  8 },
    [SPECIES_QWILFISH]                     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_SCIZOR]                       = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_SHUCKLE]                      = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 11 },
    [SPECIES_HERACROSS]                    = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  2 },
    [SPECIES_SNEASEL]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_TEDDIURSA]                    = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    [SPECIES_URSARING]                     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_SLUGMA]                       = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_MAGCARGO]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_SWINUB]                       = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    [SPECIES_PILOSWINE]                    = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  8 },
    [SPECIES_CORSOLA]                      = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  8 },
    [SPECIES_REMORAID]                     = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 12 },
    [SPECIES_OCTILLERY]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
    [SPECIES_DELIBIRD]                     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_MANTINE]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_SKARMORY]                     = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  1 },
    [SPECIES_HOUNDOUR]                     = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 10 },
    [SPECIES_HOUNDOOM]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_KINGDRA]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_PHANPY]                       = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 12 },
    [SPECIES_DONPHAN]                      = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    [SPECIES_PORYGON2]                     = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 11 },
    [SPECIES_STANTLER]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_SMEARGLE]                     = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    ...
    [SPECIES_MILTANK]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    ...
    [SPECIES_LARVITAR]                     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  8 },
    [SPECIES_PUPITAR]                      = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  9 },
    [SPECIES_TYRANITAR]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    ...
    [SPECIES_POOCHYENA]                    = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    [SPECIES_MIGHTYENA]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_ZIGZAGOON]                    = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_LINOONE]                      = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 12 },
    [SPECIES_WURMPLE]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_SILCOON]                      = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 13 },
    [SPECIES_BEAUTIFLY]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_CASCOON]                      = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    [SPECIES_DUSTOX]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_LOTAD]                        = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 12 },
    [SPECIES_LOMBRE]                       = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  6 },
    [SPECIES_LUDICOLO]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_SEEDOT]                       = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    [SPECIES_NUZLEAF]                      = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_SHIFTRY]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  9 },
    ...
    [SPECIES_TAILLOW]                      = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    [SPECIES_SWELLOW]                      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_SHROOMISH]                    = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_BRELOOM]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_SPINDA]                       = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  4 },
    [SPECIES_WINGULL]                      = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 13 },
    [SPECIES_PELIPPER]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_SURSKIT]                      = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 13 },
    [SPECIES_MASQUERAIN]                   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_WAILMER]                      = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    [SPECIES_WAILORD]                      = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 14 },
    [SPECIES_SKITTY]                       = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_DELCATTY]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_KECLEON]                      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_BALTOY]                       = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  8 },
    [SPECIES_CLAYDOL]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_NOSEPASS]                     = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 10 },
    [SPECIES_TORKOAL]                      = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  8 },
    [SPECIES_SABLEYE]                      = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 13 },
    [SPECIES_BARBOACH]                     = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_WHISCASH]                     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    [SPECIES_LUVDISC]                      = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 10 },
    [SPECIES_CORPHISH]                     = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  8 },
    [SPECIES_CRAWDAUNT]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_FEEBAS]                       = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  6 },
    [SPECIES_MILOTIC]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_CARVANHA]                     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    [SPECIES_SHARPEDO]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_TRAPINCH]                     = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    [SPECIES_VIBRAVA]                      = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 12 },
    [SPECIES_FLYGON]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_MAKUHITA]                     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  8 },
    [SPECIES_HARIYAMA]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_ELECTRIKE]                    = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 13 },
    [SPECIES_MANECTRIC]                    = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  0 },
    [SPECIES_NUMEL]                        = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_CAMERUPT]                     = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 13 },
    [SPECIES_SPHEAL]                       = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 15 },
    [SPECIES_SEALEO]                       = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    [SPECIES_WALREIN]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_CACNEA]                       = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 12 },
    ...
    [SPECIES_LUNATONE]                     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_SOLROCK]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_AZURILL]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_SPOINK]                       = { .size = MON_COORDS_SIZE(40, 64), .y_offset =  4 },
    [SPECIES_GRUMPIG]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_PLUSLE]                       = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  3 },
    [SPECIES_MINUN]                        = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  4 },
    [SPECIES_MAWILE]                       = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_MEDITITE]                     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  9 },
    [SPECIES_MEDICHAM]                     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  0 },
    [SPECIES_SWABLU]                       = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    [SPECIES_ALTARIA]                      = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    [SPECIES_WYNAUT]                       = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 11 },
    [SPECIES_DUSKULL]                      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  8 },
    [SPECIES_DUSCLOPS]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_ROSELIA]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
    [SPECIES_SLAKOTH]                      = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 12 },
    [SPECIES_VIGOROTH]                     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  0 },
    [SPECIES_SLAKING]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_GULPIN]                       = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_SWALOT]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_TROPIUS]                      = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  0 },
    [SPECIES_WHISMUR]                      = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 12 },
    [SPECIES_LOUDRED]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
    [SPECIES_EXPLOUD]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_CLAMPERL]                     = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 13 },
    [SPECIES_HUNTAIL]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_GOREBYSS]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_ABSOL]                        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_SHUPPET]                      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  5 },
    [SPECIES_BANETTE]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  5 },
    [SPECIES_SEVIPER]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_ZANGOOSE]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_RELICANTH]                    = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 12 },
    ...
    [SPECIES_ANORITH]                      = { .size = MON_COORDS_SIZE(56, 32), .y_offset = 19 },
    ...
    [SPECIES_BAGON]                        = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  6 },
    [SPECIES_SHELGON]                      = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 12 },
    [SPECIES_SALAMENCE]                    = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  4 },
    [SPECIES_BELDUM]                       = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    [SPECIES_METANG]                       = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 13 },
    ...
    [SPECIES_GROTLE]                       = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    [SPECIES_TORTERRA]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_CHIMCHAR]                     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_MONFERNO]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_INFERNAPE]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_PIPLUP]                       = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 10 },
    [SPECIES_PRINPLUP]                     = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  7 },
    [SPECIES_EMPOLEON]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_STARLY]                       = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 11 },
    [SPECIES_STARAVIA]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    [SPECIES_STARAPTOR]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_BIDOOF]                       = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 13 },
    [SPECIES_BIBAREL]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_KRICKETOT]                    = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  6 },
    [SPECIES_KRICKETUNE]                   = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  3 },
    ...
    [SPECIES_CRANIDOS]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    ...
    [SPECIES_PACHIRISU]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    ...
    [SPECIES_BUNEARY]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    [SPECIES_LOPUNNY]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
    [SPECIES_MISMAGIUS]                    = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  3 },
    [SPECIES_HONCHKROW]                    = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  8 },
    [SPECIES_GLAMEOW]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_PURUGLY]                      = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  8 },
    [SPECIES_CHINGLING]                    = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 13 },
    [SPECIES_STUNKY]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    [SPECIES_SKUNTANK]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    [SPECIES_BRONZOR]                      = { .size = MON_COORDS_SIZE(40, 48), .y_offset =  9 },
    [SPECIES_BRONZONG]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    ...
    [SPECIES_CHATOT]                       = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  9 },
    [SPECIES_SPIRITOMB]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
    [SPECIES_GIBLE]                        = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_GABITE]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_GARCHOMP]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    ...
    [SPECIES_HIPPOPOTAS]                   = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 14 },
    [SPECIES_HIPPOWDON]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_SKORUPI]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_DRAPION]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    ...
    [SPECIES_ABOMASNOW]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    ...
    [SPECIES_SERVINE]                      = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  5 },
    [SPECIES_SERPERIOR]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_TEPIG]                        = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  8 },
    [SPECIES_PIGNITE]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  9 },
    [SPECIES_EMBOAR]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    [SPECIES_OSHAWOTT]                     = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 14 },
    [SPECIES_DEWOTT]                       = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  5 },
    [SPECIES_SAMUROTT]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
    [SPECIES_PATRAT]                       = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 12 },
    [SPECIES_WATCHOG]                      = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_LILLIPUP]                     = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 12 },
    [SPECIES_HERDIER]                      = { .size = MON_COORDS_SIZE(48, 56), .y_offset = 10 },
    [SPECIES_STOUTLAND]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_PURRLOIN]                     = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_LIEPARD]                      = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_PANSAGE]                      = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  9 },
    [SPECIES_SIMISAGE]                     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  6 },
    [SPECIES_PANSEAR]                      = { .size = MON_COORDS_SIZE(48, 56), .y_offset = 10 },
    [SPECIES_SIMISEAR]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
    ...
    [SPECIES_MUSHARNA]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  8 },
    ...
    [SPECIES_BLITZLE]                      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  7 },
    [SPECIES_ZEBSTRIKA]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
    [SPECIES_ROGGENROLA]                   = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 13 },
    [SPECIES_BOLDORE]                      = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 16 },
    [SPECIES_GIGALITH]                     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_WOOBAT]                       = { .size = MON_COORDS_SIZE(64, 32), .y_offset = 16 },
    [SPECIES_SWOOBAT]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
    [SPECIES_DRILBUR]                      = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 13 },
    [SPECIES_EXCADRILL]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 11 },
    [SPECIES_AUDINO]                       = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  9 },
    [SPECIES_TIMBURR]                      = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 15 },
    [SPECIES_GURDURR]                      = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    [SPECIES_CONKELDURR]                   = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 13 },
    [SPECIES_TYMPOLE]                      = { .size = MON_COORDS_SIZE(40, 32), .y_offset = 17 },
    [SPECIES_PALPITOAD]                    = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 12 },
    [SPECIES_SEISMITOAD]                   = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 12 },
    [SPECIES_THROH]                        = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    [SPECIES_SAWK]                         = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 13 },
    [SPECIES_SEWADDLE]                     = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 13 },
    [SPECIES_SWADLOON]                     = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    [SPECIES_LEAVANNY]                     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  0 },
    [SPECIES_VENIPEDE]                     = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 14 },
    [SPECIES_WHIRLIPEDE]                   = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 15 },
    [SPECIES_SCOLIPEDE]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    [SPECIES_COTTONEE]                     = { .size = MON_COORDS_SIZE(64, 32), .y_offset = 18 },
    ...
    [SPECIES_SIGILYPH]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
    [SPECIES_YAMASK]                       = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 14 },
    [SPECIES_COFAGRIGUS]                   = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_TIRTOUGA]                     = { .size = MON_COORDS_SIZE(64, 32), .y_offset = 16 },
    [SPECIES_CARRACOSTA]                   = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 13 },
    [SPECIES_ARCHEN]                       = { .size = MON_COORDS_SIZE(64, 32), .y_offset = 16 },
    [SPECIES_ARCHEOPS]                     = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 12 },
    [SPECIES_TRUBBISH]                     = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 13 },
    [SPECIES_GARBODOR]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  5 },
    [SPECIES_ZORUA]                        = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_ZOROARK]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 10 },
    [SPECIES_MINCCINO]                     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_CINCCINO]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_GOTHITA]                      = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    [SPECIES_GOTHORITA]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_GOTHITELLE]                   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_SOLOSIS]                      = { .size = MON_COORDS_SIZE(48, 32), .y_offset = 19 },
    [SPECIES_DUOSION]                      = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 13 },
    [SPECIES_REUNICLUS]                    = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 13 },
    [SPECIES_DUCKLETT]                     = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    [SPECIES_SWANNA]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    ...
    [SPECIES_FOONGUS]                      = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 13 },
    [SPECIES_AMOONGUSS]                    = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 12 },
    [SPECIES_FRILLISH]                     = { .size = MON_COORDS_SIZE(40, 56), .y_offset =  7 },
    [SPECIES_JELLICENT]                    = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    [SPECIES_ALOMOMOLA]                    = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  0 },
    [SPECIES_JOLTIK]                       = { .size = MON_COORDS_SIZE(48, 32), .y_offset = 19 },
    [SPECIES_GALVANTULA]                   = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 18 },
    [SPECIES_FERROSEED]                    = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 15 },
    [SPECIES_FERROTHORN]                   = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 14 },
    [SPECIES_KLINK]                        = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 17 },
    [SPECIES_KLANG]                        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
    [SPECIES_KLINKLANG]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  7 },
    [SPECIES_TYNAMO]                       = { .size = MON_COORDS_SIZE(64, 24), .y_offset = 21 },
    [SPECIES_EELEKTRIK]                    = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  4 },
    [SPECIES_EELEKTROSS]                   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_ELGYEM]                       = { .size = MON_COORDS_SIZE(48, 56), .y_offset = 10 },
    [SPECIES_BEHEEYEM]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_LITWICK]                      = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 14 },
    [SPECIES_LAMPENT]                      = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 12 },
    [SPECIES_CHANDELURE]                   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_AXEW]                         = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  8 },
    [SPECIES_FRAXURE]                      = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 13 },
    [SPECIES_HAXORUS]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
    [SPECIES_CUBCHOO]                      = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 12 },
    [SPECIES_BEARTIC]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  5 },
    [SPECIES_CRYOGONAL]                    = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  4 },
    [SPECIES_SHELMET]                      = { .size = MON_COORDS_SIZE(64, 32), .y_offset = 19 },
    [SPECIES_ACCELGOR]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_STUNFISK]                     = { .size = MON_COORDS_SIZE(64, 24), .y_offset = 22 },
    [SPECIES_MIENFOO]                      = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 14 },
    [SPECIES_MIENSHAO]                     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  7 },
    [SPECIES_DRUDDIGON]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
    [SPECIES_GOLETT]                       = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
    [SPECIES_GOLURK]                       = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_PAWNIARD]                     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    [SPECIES_BISHARP]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_BOUFFALANT]                   = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_RUFFLET]                      = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  9 },
    [SPECIES_BRAVIARY]                     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    [SPECIES_VULLABY]                      = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 14 },
    [SPECIES_MANDIBUZZ]                    = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    [SPECIES_HEATMOR]                      = { .size = MON_COORDS_SIZE(64, 24), .y_offset = 21 },
    [SPECIES_DURANT]                       = { .size = MON_COORDS_SIZE(64, 32), .y_offset = 17 },
    ...
    [SPECIES_LARVESTA]                     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 12 },
    [SPECIES_VOLCARONA]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    ...
    [SPECIES_FENNEKIN]                     = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  8 },
    [SPECIES_BRAIXEN]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 10 },
    [SPECIES_DELPHOX]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    ...
    [SPECIES_BUNNELBY]                     = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  0 },
    [SPECIES_DIGGERSBY]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_FLETCHLING]                   = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 14 },
    [SPECIES_FLETCHINDER]                  = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    ...
    [SPECIES_SLURPUFF]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    [SPECIES_INKAY]                        = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  9 },
    [SPECIES_MALAMAR]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
    ...
    [SPECIES_HELIOPTILE]                   = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    [SPECIES_HELIOLISK]                    = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_TYRUNT]                       = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    [SPECIES_TYRANTRUM]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 11 },
    [SPECIES_AMAURA]                       = { .size = MON_COORDS_SIZE(40, 64), .y_offset =  3 },
    [SPECIES_AURORUS]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_SYLVEON]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    [SPECIES_HAWLUCHA]                     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    [SPECIES_DEDENNE]                      = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 12 },
    [SPECIES_CARBINK]                      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  7 },
    [SPECIES_GOOMY]                        = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  9 },
    [SPECIES_SLIGGOO]                      = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  0 },
    ...
    [SPECIES_ROWLET]                       = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 15 },
    [SPECIES_DARTRIX]                      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  4 },
    [SPECIES_DECIDUEYE]                    = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  0 },
    [SPECIES_LITTEN]                       = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    [SPECIES_TORRACAT]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_INCINEROAR]                   = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_POPPLIO]                      = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 11 },
    [SPECIES_BRIONNE]                      = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  9 },
    [SPECIES_PRIMARINA]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_PIKIPEK]                      = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_TRUMBEAK]                     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_TOUCANNON]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_YUNGOOS]                      = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 14 },
    [SPECIES_GUMSHOOS]                     = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  7 },
    [SPECIES_GRUBBIN]                      = { .size = MON_COORDS_SIZE(64, 32), .y_offset = 16 },
    [SPECIES_CHARJABUG]                    = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 15 },
    ...
    [SPECIES_MUDSDALE]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
    [SPECIES_DEWPIDER]                     = { .size = MON_COORDS_SIZE(40, 48), .y_offset =  8 },
    [SPECIES_ARAQUANID]                    = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 12 },
    [SPECIES_FOMANTIS]                     = { .size = MON_COORDS_SIZE(40, 56), .y_offset =  5 },
    [SPECIES_LURANTIS]                     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  1 },
    [SPECIES_MORELULL]                     = { .size = MON_COORDS_SIZE(40, 48), .y_offset =  9 },
    [SPECIES_SHIINOTIC]                    = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  8 },
    [SPECIES_SALANDIT]                     = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 12 },
    [SPECIES_SALAZZLE]                     = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  3 },
    [SPECIES_STUFFUL]                      = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 12 },
    [SPECIES_BEWEAR]                       = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_BOUNSWEET]                    = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 14 },
    [SPECIES_STEENEE]                      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  8 },
    [SPECIES_TSAREENA]                     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_COMFEY]                       = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 11 },
    [SPECIES_ORANGURU]                     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 12 },
    [SPECIES_PASSIMIAN]                    = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  7 },
    [SPECIES_WIMPOD]                       = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    [SPECIES_GOLISOPOD]                    = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  9 },
    [SPECIES_SANDYGAST]                    = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 11 },
    ...
    [SPECIES_JANGMO_O]                     = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  7 },
    [SPECIES_HAKAMO_O]                     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  5 },
    [SPECIES_KOMMO_O]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    ...
    [SPECIES_GROOKEY]                      = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  8 },
    [SPECIES_THWACKEY]                     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  5 },
    [SPECIES_RILLABOOM]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_SCORBUNNY]                    = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  4 },
    [SPECIES_RABOOT]                       = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_CINDERACE]                    = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  4 },
    [SPECIES_SOBBLE]                       = { .size = MON_COORDS_SIZE(40, 56), .y_offset =  8 },
    [SPECIES_DRIZZILE]                     = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_INTELEON]                     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  4 },
    [SPECIES_SKWOVET]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_GREEDENT]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
    [SPECIES_ROOKIDEE]                     = { .size = MON_COORDS_SIZE(64, 32), .y_offset = 17 },
    [SPECIES_CORVISQUIRE]                  = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  9 },
    [SPECIES_CORVIKNIGHT]                  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_BLIPBUG]                      = { .size = MON_COORDS_SIZE(40, 56), .y_offset =  7 },
    [SPECIES_DOTTLER]                      = { .size = MON_COORDS_SIZE(56, 32), .y_offset = 17 },
    [SPECIES_ORBEETLE]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_NICKIT]                       = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
    [SPECIES_THIEVUL]                      = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_GOSSIFLEUR]                   = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 15 },
    [SPECIES_ELDEGOSS]                     = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 15 },
    [SPECIES_WOOLOO]                       = { .size = MON_COORDS_SIZE(56, 32), .y_offset = 18 },
    [SPECIES_DUBWOOL]                      = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 13 },
    [SPECIES_CHEWTLE]                      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  8 },
    [SPECIES_DREDNAW]                      = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 18 },
    [SPECIES_YAMPER]                       = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 13 },
    [SPECIES_BOLTUND]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
    [SPECIES_ROLYCOLY]                     = { .size = MON_COORDS_SIZE(64, 32), .y_offset = 17 },
    [SPECIES_CARKOL]                       = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    [SPECIES_COALOSSAL]                    = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    [SPECIES_APPLIN]                       = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 15 },
    [SPECIES_FLAPPLE]                      = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  8 },
    [SPECIES_APPLETUN]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset = 11 },
    [SPECIES_SILICOBRA]                    = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 10 },
    [SPECIES_SANDACONDA]                   = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 13 },
    ...
    [SPECIES_IMPIDIMP]                     = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 13 },
    [SPECIES_MORGREM]                      = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 11 },
    [SPECIES_GRIMMSNARL]                   = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 10 },
    ...
    [SPECIES_ARCTOZOLT]                    = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  8 },
    [SPECIES_DRACOVISH]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    [SPECIES_ARCTOVISH]                    = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 11 },
    [SPECIES_DURALUDON]                    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
...
#endif
    [SPECIES_DSRAYQUAZA]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_LOPUNNY_MEGA]                 = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  3 },
    [SPECIES_GARCHOMP_MEGA]                = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_LUCARIO_MEGA]                 = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_ABOMASNOW_MEGA]               = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    ...
    [SPECIES_SLOWKING_GALARIAN]            = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  3 },
 ...
 // Hisuian Forms
    ...
    // Wormadam
    [SPECIES_WORMADAM_SANDY_CLOAK]         = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  2 },
    [SPECIES_WORMADAM_TRASH_CLOAK]         = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    // Cherrim
    ...
    // Meowstic
    [SPECIES_MEOWSTIC_FEMALE]              = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  9 },
    // Aegislash
    ...
    [SPECIES_MINIOR_METEOR_GREEN]          = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 14 },
    [SPECIES_MINIOR_METEOR_BLUE]           = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 14 },
    [SPECIES_MINIOR_METEOR_INDIGO]         = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 14 },
    [SPECIES_MINIOR_METEOR_VIOLET]         = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 14 },
    [SPECIES_MINIOR_CORE_RED]              = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    [SPECIES_MINIOR_CORE_ORANGE]           = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    [SPECIES_MINIOR_CORE_YELLOW]           = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    [SPECIES_MINIOR_CORE_GREEN]            = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    [SPECIES_MINIOR_CORE_BLUE]             = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    [SPECIES_MINIOR_CORE_INDIGO]           = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    [SPECIES_MINIOR_CORE_VIOLET]           = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 15 },
    // Mimikyu
    ...
    // Indeedee
    [SPECIES_INDEEDEE_FEMALE]              = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    // Morpeko
